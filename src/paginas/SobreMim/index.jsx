    ...
    return (
        ...
        >
            ...
            <p className={styles.paragrafo}>
                Me apresento inicialmente como programador, minha história com programação, começou em 2020 quando entrei para ETEC (Escola Técnica Estadual). Desde muito jovem meu fascínio pela exploração do desconhecido me levou a mergulhar de cabeça no universo da programação e outras áreas do meu interesse.
            </p>
            <p className={styles.paragrafo}>
            ...
            <p className={styles.paragrafo}>
                Minha jornada de aprendizado não parou por aí. Aprendi muito na prática, no dia a dia do trabalho, e também na maior escola de tecnologia da América Latina: a Alura. Agora, munido das ferramentas necessárias, estou em constante evolução e aprendizado. Uma frase que ecoou profundamente em mim durante todo esse processo foi a frase de Sérgio Cortella: "Faça o teu melhor na condição que você tem, enquanto você não tem condições melhores para fazer melhor ainda!"            </p>
            <p className={styles.paragrafo}>
